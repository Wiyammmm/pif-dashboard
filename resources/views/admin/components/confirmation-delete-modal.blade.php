...
<div x-cloak x-show="{{ $show }}" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="{{ $show }}" x-transition:enter="ease-out duration-300"
            ...
            <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4"
                style="background-color: var(--branding-secondary-100); color: var(--branding-primary-900);">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                {{ $message }}
                                @if ($itemName)
                                    <br><strong class="text-gray-700">"{{ $itemName }}"</strong>
                                @endif
                            </p>
                        </div>
                    </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <button type="button" @click="{{ $cancelAction }}"
                    class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm transition">
                    {{ $cancelText }}
                </button>
            </div>
        </div>
