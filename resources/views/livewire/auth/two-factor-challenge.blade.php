    ...
    <div class="flex flex-col gap-6">
        <div class="relative w-full h-auto" x-cloak x-data="{
            ...
            <div x-show="!showRecoveryInput">
                <x-member::auth-header :title="__('Authentication Code')" :description="__('Enter the authentication code provided by your authenticator application.')" />
            </div>

            <div x-show="showRecoveryInput">
                <x-member::auth-header :title="__('Recovery Code')" :description="__(
