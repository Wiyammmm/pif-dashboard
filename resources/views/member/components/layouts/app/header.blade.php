...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            <flux:navbar.item icon="layout-grid" :href="route('member.dashboard')"
                :current="request()->routeIs('member.dashboard')" wire:navigate>
                {{ __('Dashboard') }}
            </flux:navbar.item>
        </flux:navbar>
        ...
        <flux:dropdown position="top" align="end">
            ...
            <flux:menu>
                ...
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('member.settings')" icon="cog" wire:navigate>{{ __('Settings') }}
                    </flux:menu.item>
                </flux:menu.radio.group>
    ...
    <flux:sidebar stashable sticky
        ...
        <a href="{{ route('member.dashboard') }}" class="ms-1 flex items-center space-x-2 rtl:space-x-reverse"
            wire:navigate>
            <x-member::app-logo />
        </a>
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')">
                <flux:navlist.item icon="layout-grid" :href="route('member.dashboard')"
                    :current="request()->routeIs('member.dashboard')" wire:navigate>
                    {{ __('Dashboard') }}
                </flux:navlist.item>
            </flux:navlist.group>
